...
function SignUp() {
  ...
  return (
    <>
      <div className='mx-auto items-center justify-center flex flex-row bg-gray-100 h-[120vh]'>
        <motion.div
        ...
        >
          <div className=''>
            <div className='relative flex flex-col items-center h-[97vh] border-2 p-12 mt-24 bg-white'>
              <div>
