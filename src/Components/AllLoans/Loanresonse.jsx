            ...
            <div className="overflow-x-auto">
              <table className="w-[80%] bg-slate-50 border border-gray-200">
                <tbody>
                  ...
                  <tr>
                    <td className="py-3 px-4 sm:px-6 lg:px-8 font-bold">Monthly Repayment Amount</td>
                    <td className="py-3 px-4 sm:px-6 lg:px-8">{loanResponse.monthlyRepaymentAmount}</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td className="py-3 px-4 sm:px-6 lg:px-8 font-bold">Approved Amount</td>
                  ...
                  <tr>
                    ...
                    <td className="py-3 px-4 sm:px-6 lg:px-8">{loanResponse.amountRequested || "Not available"}</td>
                  </tr>
                  <tr>
